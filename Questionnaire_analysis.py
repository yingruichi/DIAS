...
class QuestionnaireAnalysisApp:
    def __init__(self, root=None):
        ...
        self.LANGUAGES = {
            ...
            'en': {
                'title': "(DIAS) Questionnaire analysis",
    ...
    def load_data(self):
        ...
        # 构建 Excel 文件的相对路径
        excel_file_path = os.path.join(current_dir, 'Excel', 'Questionnaire analysis.xlsx')
