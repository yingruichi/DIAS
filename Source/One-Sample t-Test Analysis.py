...
LANGUAGES = {
    ...
    'en': {
        ...
        'explanation': {
            "单样本 t 检验": "Used to test whether there is a significant difference between the sample mean and a known population mean.",
            "t 统计量": "A statistic that measures the difference between the sample mean and the population mean.",
            "自由度": "The number of independent values that can vary in a statistical calculation.",
            "p 值": "A probability value used to determine whether to reject the null hypothesis.",
            "均值差异的置信区间": "An interval range that contains the difference in population means.",
            "样本均值": "The average value of the sample data.",
            "样本标准差": "A measure of the dispersion of the sample data."
        },
        'interpretation': {
            "t 统计量": "The larger the absolute value of the t-statistic, the more significant the difference between the sample mean and the population mean.",
            "p 值": "When the p-value is less than the significance level (usually 0.05), the null hypothesis is rejected, indicating a significant difference between the sample mean and the population mean; otherwise, the null hypothesis is accepted.",
            ...
            "均值差异的置信区间": "If the confidence interval does not contain 0, it indicates a significant difference between the sample mean and the population mean.",
            "样本均值": "Reflects the average level of the sample data.",
            "样本标准差": "Reflects the dispersion of the sample data."
        }
    }
}
...
def analyze_file():
    ...
    try:
        ...
        for column in numerical_df.columns:
            ...
            sample_std = data.std()
            confidence_interval = stats.t.interval(0.95, degrees_of_freedom, loc=sample_mean - population_mean,
                                                   scale=stats.sem(data))

            results.append([column, t_stat, degrees_of_freedom, p_value, confidence_interval, sample_mean, sample_std])

        # 整理数据
        headers = ["变量", "t 统计量", "自由度", "p 值", "均值差异的置信区间", "样本均值", "样本标准差"]
        ...
        for column in numerical_df.columns:
            ...
            # 保存图片到桌面
            save_image_path = os.path.join(desktop_path, f"{column}_charts.png")
