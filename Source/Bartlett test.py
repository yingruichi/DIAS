...
def analyze_file():
    ...
    try:
        ...
        if len(column_data) > 1:
            ...
            values = [bartlett_statistic, bartlett_p_value, None, interpretation]
        ...
        if save_path:
            ...
            # 添加标题
            doc.add_heading('Bartlett 检验结果', 0)
